"""
Egnex CV Watcher — monitors a folder (default: ~/Downloads) and
...
log = logging.getLogger("egnex-watcher")
...
def _upload(path: Path):
    """Upload a single file to Egnex CV Repository."""
