...
separate from the main Egnex backend.

Workflow:
  1. Egnex backend POSTs {face image + audio file} to /render
...
app = FastAPI(title="Egnex SadTalker Service")

GCS_BUCKET   = os.environ.get("GCS_BUCKET", "egnex-nexai-media")
