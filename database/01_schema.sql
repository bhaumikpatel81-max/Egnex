...
-- stored as editable DATA, not hard-coded. When Amnex changes
...
-- Group companies: Amnex (parent), Maxsapient, Andpayments, etc.
...
CREATE TABLE candidate (
    ...
    -- gender is the only diversity axis Amnex tracks today;
