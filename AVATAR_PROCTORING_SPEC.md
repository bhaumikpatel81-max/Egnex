# Egnex — AI Avatar + Proctoring build spec (NexAI interview)
...
Replace the static NexAI interview screen with an animated orb/waveform that reacts to the playing audio amplitude. Egnex fire-orange accent. Verify: start a NexAI interview, the orb animates while each question is spoken.
